...
Demonstrates two NIST + Tampere VECSEL systems at 1117 nm (intracavity-doubled IC-VECSEL → 280 nm) and 1141 nm (vertically-coupled VC-VECSEL → 285 nm) for trapped ²⁵Mg⁺ generation and manipulation. Reports < 50 kHz seed linewidth at 280 nm, ASE-suppressed output, and operational use as both Doppler-cooling and photoionisation lasers. **Relevance:** the wavelength-adjacent ²⁵Mg⁺ companion to [Burd23] — closest published demonstration to the 1118 nm Friedenauer fundamental, anchoring the gain-mirror feasibility envelope for the in-house build.
