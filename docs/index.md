...
If you want the source: [GitHub repository](https://github.com/uwarring82/mg-plus-uv-chain) · [Charter v1.0](https://github.com/uwarring82/mg-plus-uv-chain/blob/main/CHARTER.md) · [Phase 1 dossier](KD-2026-XXX-uv-280nm.html) · [References](references.html) · [Architectures](architectures/) · [Components — Friedenauer baseline](components/friedenauer-baseline.html) · [Components — Seed lasers (VECSEL)](components/seed-lasers.html) · [Tutorials](tutorials/) · [BK recalculation notebook](https://github.com/uwarring82/mg-plus-uv-chain/blob/main/notebooks/2026-05-01-friedenauer-bk-recalculation.py)
