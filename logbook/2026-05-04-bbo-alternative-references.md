...
- **Task E (CW-UV LIDT at 280 nm)** — **the only residual binding open item** for `KD-UV280-005` Section C. Deserves its own logbook task; dispatching it requires CW-UV-degradation operational papers, which are more dispersed in the literature than the crystal-property surveys for tasks A and B.
