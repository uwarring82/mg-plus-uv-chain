...
**Progress 2026-09-09:** README status and its existing/planned path split are corrected; dossier index rows 008/009/011/012 now match their existing detail sections (9/15 past scaffold, separate from 22 extraction files). Evidence and validation are in the [RC-09 follow-up](2026-09-09-public-record-corrections.md#rc-09-follow-up--readme-status-and-existing-paths). Wider link/schema/status work remains open.
